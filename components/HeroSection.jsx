...
export function HeroSection() {
  ...
  return (
    <section className={`${poppins.className} relative w-full`}>
      {/* 🔹 Top Bar (Fixed, Transparent + Blur) */}
      <div className="fixed top-0 left-0 w-full flex justify-between items-center bg-white/90 backdrop-blur-md text-xs sm:text-sm px-4 sm:px-8 py-1.5 z-50 shadow-md">
        {/* Left: Contact */}
        <div className="flex items-center gap-2 sm:gap-4">
          <a href="tel:+9113789574" className="text-gray-900 font-medium hover:text-blue-600 transition">
            📞 +9113789574
          </a>
        </div>
      ...
      <div
        id="next-section"
        className="w-full min-h-[60vh] bg-white flex flex-col justify-center items-center text-center px-6 py-12"
      >
        ...
        <p className="text-gray-700 max-w-2xl text-base sm:text-lg leading-relaxed">
          Step into the world of innovation, creativity, and excellence — where every idea turns into a masterpiece.
          Scroll further to explore more about us.
        </p>
      </div>
    </section>
  );
