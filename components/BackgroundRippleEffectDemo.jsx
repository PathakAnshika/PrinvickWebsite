...
export function BackgroundRippleEffectDemo() {
  return (
    <section className="flex justify-center py-24 bg-gray-50 dark:bg-gray-900">
      <div className="w-full max-w-7xl px-6 md:px-12 text-center">
        ...
        <div className="relative flex justify-center items-center w-full mt-6">
          <span
            className={`${cursiveFont.className} text-2xl md:text-4xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-sky-500 to-sky-600 drop-shadow-md`}
          >
        ...
        {/* Paragraph */}
        <p
          className={`${cursiveFont.className} text-center text-gray-600 dark:text-gray-300 mt-6 text-lg md:text-xl max-w-3xl mx-auto`}
        >
